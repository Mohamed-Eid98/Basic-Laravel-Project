...
<div class="card">
    <div class="card-body">
        ...
        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tr>
                <td> {{ $i++}} </td>
                <td> <img src="{{ url('upload/multi/' . $item->multi_image )}}" style="width: 60px; height: 50px;"> </td>

                <td>
<a href="{{route('edit.multiple.image', $item->id)}}" class="btn btn-info sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>
